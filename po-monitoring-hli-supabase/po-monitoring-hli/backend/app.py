...
def get_dashboard_stats():
    try:
        ...
        # PERBAIKAN: Ambil semua last upload sekaligus agar tidak kosong
...
def upload_smro():
    try:
        ...
        # PERBAIKAN: Hanya ambil SO dari DB yang matching dengan file upload, bukan load semua
...
def upload_product_id():
    ...
    try:
        ...
        # PERBAIKAN: Pre-load Product ID untuk hindari query DB di dalam loop
...
def upload_master_pic():
    ...
    try:
        ...
        # PERBAIKAN: Pre-load Master PIC untuk hindari query DB di dalam loop
...
if __name__ == '__main__':
    ...
    warm_completed_summary_cache_async()
    warm_rfq_dashboard_cache_async()
    print("Backend: http://127.0.0.0:5001")
